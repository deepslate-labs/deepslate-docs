...
The `@deepslate-labs/livekit` package provides a `RealtimeModel` implementation for the [LiveKit Agents](https://github.com/livekit/agents) **Node.js / TypeScript** framework, enabling seamless integration with Deepslate's unified voice AI infrastructure.
