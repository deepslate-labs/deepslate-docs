...
<Info>
Need VAD-only without LLM inference? See the [VAD WebSocket Protocol](/api-reference/vad) for a lightweight endpoint that streams voice activity events without running the full Opal pipeline.
</Info>
